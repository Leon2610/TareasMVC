...
namespace TareasMVC.Controllers
{
    ...
    public class TareasController : ControllerBase
    {
        ...
        public async Task<List<TareaDTO>> Get()
        {
            ...
            var tareas = await context.Tareas.Where(t => t.UsuarioCreacionId == usuarioId).OrderBy(t => t.Orden).ProjectTo<TareaDTO>(mapper.ConfigurationProvider).ToListAsync();
            return tareas;
        }
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var tareas = await context.Tareas.Where(t => t.UsuarioCreacion.Id == usuarioId).ToListAsync();
