...
namespace TareasMVC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        [AllowAnonymous]
        [HttpGet]
        public ChallengeResult LoginExterno(string provider, string returnUrl = null)
        {
            var urlRedireccion = Url.Action("RegistrarUsuarioExterno", values: new { returnUrl });
            var propiedades = signInManager.ConfigureExternalAuthenticationProperties(provider, urlRedireccion);

            return new ChallengeResult(provider, propiedades);
        }
